// ============================
// 📄 routes/dbzDB/planetas/actualizarImagen.js
// ============================
"use strict";
...
router.put("/actualizarImagen/:id_api",
    ...
    (req, res) => {
        ...
        const sql = "UPDATE planetas SET image_blob = ? WHERE id_api = ?";
        ...
        connection.query(sql, [buffer, id_api], (error, results) => {
            ...
            if (results.affectedRows === 0) {
                return res.status(404).json({ success: false, mensaje: "Planeta no encontrado" });
            }

            res.json({ success: true, mensaje: `🖼️ Imagen del planeta ${id_api} actualizada` });
        });
    }
);
