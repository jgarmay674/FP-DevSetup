// ============================
// 📄 routes/dbzDB/personajes/actualizarImagen.js
// ============================
"use strict";
    ...
    (req, res) => {
        ...
        connection.query(sql, [buffer, id_api], (error, results) => {
            ...
            if (results.affectedRows === 0) {
                return res.status(404).json({ success: false, mensaje: "Personaje no encontrado" });
            }

            res.json({ success: true, mensaje: `🖼️ Imagen del personaje ${id_api} actualizada` });
        });
    }
);
