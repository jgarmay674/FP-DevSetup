#!/usr/bin/env bash
# =============================================================================
#  FP-DevSetup / mac-arm/setup.sh
#  Entorno de desarrollo para Formación Profesional — DAW
#  Plataforma: Mac ARM (M1/M2/M3/M4)
#  Curso 2026-2027
# =============================================================================
...
echo -e "  ${CYAN}${BOLD}║   Plataforma : Mac ARM (M1/M2/M3/M4)                         ║${RESET}"
echo -e "  ${CYAN}${BOLD}║                                                              ║${RESET}"
...
echo -e "  4. ${CYAN}git config --global user.name  \"Tu Nombre\"${RESET}"
echo -e "  5. ${CYAN}git config --global user.email \"tu@email.com\"${RESET}"
echo -e "  6. ${CYAN}docker run hello-world${RESET}"
echo -e "  7. ${CYAN}cd $ROOT_DIR/entorno && docker compose up -d${RESET}"
echo ""
